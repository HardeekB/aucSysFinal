...
<body>
    ...
    <div class="container">
        <div class="frame">
            <div class="nav">
                <ul class="links">
                    <li class="signin-active"><a class="btn">Sign In For Bidder</a></li>
                
                </ul>
            </div>
            <div ng-app ng-init="checked = false">
                <form class="form-signin" action="/bidder/signIn" method="post" name="form"> 
            ...
            <br>
            <div class="SignUp"> <a href="/bidder/signUp">Don't Have A Account?Sign Up</a> </div>
