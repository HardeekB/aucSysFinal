...
<body>
    ...
    <div class="container">
        <div class="frame">
            <div class="nav">
                <ul class="links">
                    <li class="signin-active"><a class="btn">Sign Up For Bidder</a></li>
                
                </ul>
            </div>
            
            <div ng-app ng-init="checked = false">
                <form class="form-signin" action="/bidder/signUp" method="post" name="form">  
            ...
            <div class="SignIn"> <a href="/bidder/signIn">Already Have A Account?Sign In</a></div>
